...
urls = pd.read_csv(
    "C:\myanmar-website-crawlers\mizzima_urls_world.csv", header=None)
urls = np.array(urls)
urls = urls.tolist()
shuffle(urls)
...
for i in range(0,9989): # 10001
    ...
    try:
        ...
        if content_container == [] or isinstance(content_container, NoneType):
            ...
            with open("C:\myanmar-website-crawlers\Mizzima_data_World.csv", "a", encoding='utf-8') as WR:
