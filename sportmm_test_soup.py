...
my_url = "https://sportsmyanmar.com/archives/17052"

# pre-build a free list for final extracted content
extracted_content = []

# This requires a free list since sportmm website is inconsistent
final_content = []
...
# All sentences are within the <p> tags which are also within the div tag
content_container = page_soup.find("div", {"class": "entry-content"}) 
...
if content_container == []:
    ...
    with open("C:\myanmar-website-crawlers\sportmm_data.csv", "w", encoding='utf-8') as WR:
