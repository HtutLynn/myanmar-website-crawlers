...
urls = pd.read_csv(
    "C:\myanmar-website-crawlers\mizzima_urls_opinion.csv", header=None)
urls = np.array(urls)
urls = urls.tolist()
    ...
    try:
        ...
        if r not in wlist:
            ...
            if content_container == [] or isinstance(content_container, NoneType):
                ...
                with open("C:\myanmar-website-crawlers\Mizzima_data_opinion.csv", "a", encoding='utf-8') as WR:
