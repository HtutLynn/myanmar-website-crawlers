...
my_url = "https://www.rfa.org/burmese/news/rcss-denies-battle-with-other-12272018050225.html"
...
headtext_container = page_soup.findAll("div", {"id": "storypagemaincol"})
...
content_container = page_soup.find("div", {"id": "storytext"}) 
...
if content_container == []:
    ...
    with open("C:\myanmar-website-crawlers\\rfa_data.csv", "w", encoding='utf-8') as WR:
