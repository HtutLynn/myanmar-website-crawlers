...
for i in range(0,3146):
    ...
    try:
        ...
        # News
        my_url = "https://news-eleven.com/news?page="+str(i)
        ...
        articles_container = page_soup.findAll("div", {"class" : "news-title"})
        ...
        with open("C:\myanmar-website-crawlers\Eleven_urls_news.csv", "a", encoding='utf-8') as WR:
